...
> Book-Keeper is a website that stores data (links and titles) in your local storage. The site is responsive and constructed with HTML, CSS, and JavaScript. I employ linters to maintain clean code and identify errors. Feel free to explore the live demo.
...
- [Live Demo Link](https://ameer2000mzori.github.io/Book-Keeper/src/)
